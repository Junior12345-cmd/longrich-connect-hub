        ...
        <div className="container mx-auto px-4 py-3 flex items-center justify-between">
          ...
          >
            <div className="w-full h-12 flex items-center justify-center">
              <img
                src={`${import.meta.env.VITE_BACKEND_URL}/${product.shop?.logo}`}
          ...
          <div className="hidden md:block text-sm text-gray-500 text-right max-w-52">
            Téléphone : {product.shop?.phone || "N/A"} <br />
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="flex flex-col items-center md:items-start gap-3">
              ...
              <p className="text-sm text-gray-400 text-center md:text-left">
                {product.shop?.description
                  ? truncateText(stripHtml(product.shop?.description), 200)
            ...
            <div className="flex flex-col items-center md:items-start">
              ...
              <p className="mt-1 text-sm">
                Téléphone :{" "}
                <a
                  href={`tel:${product.shop?.phone || "+221123456789"}`}
                  className="hover:text-teal-400 transition-colors"
                >
                  {product.shop?.phone || "+221 123 456 789"}
                </a>
              </p>
            </div>
