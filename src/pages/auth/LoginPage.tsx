...
const LoginPage = () => {
  ...
  return (
    <div className={`min-h-screen bg-background ${theme}`}>
      ...
      {/* Main Content */}
      <main className="container-fluid mx-auto flex flex-col lg:flex-row items-center justify-center gap-8">
        ...
        <div className="w-full lg:w-[50%] relative">
          ...
          <img
            ...
            alt="Réseau Longrich"
            className="w-full lg:h-auto object-cover object-top"
            loading="lazy"
          />
        </div>
        ...
        <div className="w-full lg:w-[50%]">
          <Card className="w-full p-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-2">Connectez-vous à votre compte</h3>
